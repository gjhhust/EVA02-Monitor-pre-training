...
from dataset_folder import ImageFolder, MultiLabelDataset
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        nb_classes = 100
    elif args.data_set == 'muti_label':
        root = args.data_path if is_train else args.eval_data_path
        dataset = MultiLabelDataset(root, classes_json = args.classes_json, label_dir=args.label_dir, train=is_train, transform=transform)
